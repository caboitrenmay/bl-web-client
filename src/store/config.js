...
const storeWithObserable = () => {
    const store = createStore(
        rootReducer,
        IS_LOGGER ? applyMiddleware(epicMiddleware, {}, logger) : applyMiddleware(epicMiddleware, {})
    );
...
const storeWithThunk = createStore(rootReducer, IS_LOGGER ? applyMiddleware(thunk, logger) : applyMiddleware(thunk));
