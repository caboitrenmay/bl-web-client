 ...
 * action creators
 */
export const getNewsTodo = (indexSelected) => ({ type: GET_NEWS_TODO, payload: indexSelected })
...
export const selectNewsIndex = (indexSelected) => ({ type: SELECT_NEWS_INDEX, payload: indexSelected })